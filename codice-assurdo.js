...
const desc_json = {
    ...
    "5":"Seconda delle isole prive di fiumi esplorate grazie all’aiuto di due indigeni”,
    "6": "La sera del 27 ottobre 1492 le caravelle di Colombo arrivano alla fonda della baia di Bariay a Cuba, nell'attuale provincia di Holguín.",
    "7": "Cercando l'oro Pinzon (comandante della Pinta) ricevette informazioni su una fantomatica isola chiamata Babeque e decise, dopo qualche tentativo con Colombo, di partire da solo con la Pinta; per quasi due mesi scomparve, mentre Colombo giunse nella baia di Baracoa.",
    "8": "Colombo esplorò la costa settentrionale di Haiti, raggiunta il 5 dicembre 1492, e la chiamò Hispaniola; approdò la sera del 6 dicembre chiamando il luogo, Puerto San Nicola.",
    "9": "Cercò l'oro giungendo in quella che chiamò Bahia de los Mosquitos, nome che sopravvisse nei secoli.",
    "10": "Approdò su un isola a forma di tartaruga che il navigatore chiamò poi Tortuga",
    "11": "",
    "12": "Prima del ritorno decisero di trarre in secco le due caravelle, a Capo Samanà, per opere di manutenzione.",
    "13": "Approdarono a Gomera come nel primo viaggio e ne ripartirono il 13 ottobre 1493.",
